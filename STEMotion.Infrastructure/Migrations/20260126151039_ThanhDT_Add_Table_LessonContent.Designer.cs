...
namespace STEMotion.Infrastructure.Migrations
{
    ...
    [Migration("20260126151039_ThanhDT_Add_Table_LessonContent")]
    partial class ThanhDT_Add_Table_LessonContent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("STEMotion.Domain.Entities.LessonContent", b =>
                {
                    ...
                    b.Property<string>("SimulationConfig")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("simulation_config");
